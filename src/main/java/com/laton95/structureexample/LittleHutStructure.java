 ...
 */
public class LittleHutStructure extends ScatteredStructure<NoFeatureConfig> {
	
	public LittleHutStructure(Function<Dynamic<?>, ? extends NoFeatureConfig> config) {
		super(config);
	}
	...
	public String getStructureName() {
		return StructureExample.MOD_ID + ":little_hut";
	}
	...
	public static class Start extends StructureStart {
		...
		public void init(ChunkGenerator<?> generator, TemplateManager templateManager, int chunkX, int chunkZ, Biome biome) {
			...
			LittleHutPiece piece = new LittleHutPiece(templateManager, templateResource, new BlockPos(chunkX * 16, 0, chunkZ * 16), rotation);
